...
The official TypeScript/JavaScript SDK for [Sim](https://peerbie.com), allowing you to execute workflows programmatically from your applications.
...
const client = new SimStudioClient({
  ...
  baseUrl: 'https://peerbie.com' // optional, defaults to https://peerbie.com
});
...
- `config.baseUrl` (string, optional): Base URL for the Sim API (defaults to `https://peerbie.com`)
