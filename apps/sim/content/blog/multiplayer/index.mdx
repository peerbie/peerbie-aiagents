...
canonical: https://peerbie.com/studio/multiplayer
draft: false
---
...
*Interested in how Sim's multiplayer system works in practice? [Try building a workflow](https://peerbie.com) with a collaborator in real-time.*
